...
function GetLoadNav() {
    ...
    $.each(data, function (i) {
        ...
        if (row.ParentId == null) {
            _html += '<li>';
            _html += '<a data-id="' + row.Id + '" href="#" class="dropdown-toggle"><i class="' + row.resourceleftico + '"></i><span>' + row.resourcename + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="menuItem" data-id="' + subrow.Id + '" href="' + subrow.resourceurl + '" data-index="' + subrow.SortCode + '">' + subrow.resourcename + '</a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
