        ...
        styleUI: {
            ...
            Bootstrap: {
                ...
                filter: {
                    ...
                    srSelect: 'form-control  form-control-Athena', //kwy:改变高级搜索的样式
                    srInput: 'form-control  form-control-Athena',//kwy:改变高级搜索的样式
                    menu_widget: '',
        ...
        return this.each(function () {
            ...
            */
            ...
            this.createTableRowForRule = function (rule, group) {
                ...
                var ruleFieldTd = $("<td class='columns'></td>");//修改人：kwy，
                ...
                ruleFieldSelect.bind('change', function () {
                    ...
                    $(elm).addClass("input-elm " + classes.srInput);//修改人：kwy，
            ...
            return this.each(function () {
                ...
                if ($("#" + $.jgrid.jqID(IDs.themodal))[0] !== undefined) {
                    ...
                    if (p.tmplNames && p.tmplNames.length) {
                        found = true;
                        tmpl = "<td class='ui-search-label'>" + p.tmplLabel + "</td>";
                        tmpl += "<td><select class='ui-template " + classes.srSelect + "' style='padding-right:0px;'>";
                    ...
                    bt = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + fid + "_2'><tbody>"
                                + "<tr><td colspan='2'><hr class='" + common.content + "' style='margin:1px'/></td></tr>"
                                + "<tr><td class='EditButton' style='text-align:" + align + "'>" + bC + "</td>"
                                + tmpl
                                + "<td class='EditButton' " + butleft + ">" + bQ + bS + "</td></tr>"
                                + "</tbody></table>";
                    fid = $.jgrid.jqID(fid);
                    $("#" + fid).jqFilter({
                        columns: columns,
        ...
        var dfop =
            {
                ...
                url: false,
                param: null,
                cbiconpath:url.protocol+'//'+url.host+'/Public/Theme/Bootstrap/js/wdtree/images/icons/',//url.host
